...
header:
  overlay_color: "#000"
  overlay_filter: "0.75"
  overlay_image: https://i.imgur.com/BOIkrai.png
#   actions:
#     - label: "English"
...
![](https://i.imgur.com/C7JcqEm.png)

![](https://i.imgur.com/BkFNr6O.png)
...
```html<!-- Begin Jekyll SEO tag v2.6.1 -->
...
![](https://i.imgur.com/5QL26kj.png)


我們知道他會進行兩次替換，那我們在我們字串裡面混一些它會替換的字就好了呀：

![](https://i.imgur.com/X6vvgaF.png)
...
- 每次都得等音樂跑完，那我們把等音樂那幾行去掉就不用等啦
    - ![](https://i.imgur.com/5QV9hFp.png)

遊戲一開始馬上就能噴 Flag 了。

![](https://i.imgur.com/FZTp8ZV.png)
...
![](https://i.imgur.com/i48c924.png)

![](https://i.imgur.com/OjlxVSg.png)
...
![](https://i.imgur.com/2dA2K5Q.jpg)

![](https://i.imgur.com/jQHwDD4.jpg)

<!-- 我一開始看到這題的時候內心覺得主辦在搞我們。!-->

這題就很無腦的照著點字透過像是 decode.fr 慢慢解。沒有留 Flag。

![](https://i.imgur.com/GV8ZvhF.png)
...
![](https://i.imgur.com/0y8L2ah.png)

很可惜的，沒那麼簡單。

![](https://i.imgur.com/DVuodd0.png)
...
![](https://i.imgur.com/Y2lzuXE.png)

### 🌱 Soy (139 pt.)

![](https://i.imgur.com/yCCp9U3.png)

這題是 QR Code recovery，最近[大家似乎都很喜歡考這題](https://hsctf.com/)。很可惜的，QRazyBox 不是很喜歡這種被蓋掉重要部份的 QR Code。

![](https://i.imgur.com/ODAaW8P.png)

這時候就得人工介入了，我們依部份黑點可以隱約看出哪部分有可能是黑的或白的。我們可以透過 Brightness & Contrast 調整幫助 QRazyBox 辨識。

![](https://i.imgur.com/FwLVG94.png)

![](https://i.imgur.com/VTM1LQX.png)

接著我們在人工把 Position 部分跟 Finder 加回去。

![](https://i.imgur.com/rWkRJAw.png)

這時候丟進 QRazyBox 就好了。

![](https://i.imgur.com/gEJgFlK.png)

接著我們可以強制要求 QRazyBox 把讀得出來的東西拉出來。

![](https://i.imgur.com/4WdIisY.png)
